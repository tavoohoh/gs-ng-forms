 ...
 */
class GFieldStringConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for only string fields
 */
class GFieldMapConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for only number fields
 */
class GFieldNumberConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for only boolean fields
 */
class GFieldBooleanConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration including option values for `GRadioField` and `GDropdownField`
 */
class GFieldOptionValuesConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration including country option for `GCurrencyField` and `GPhoneField`
 */
class GFieldCountryFormmatConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for `GFieldFile`
 */
class GFieldFileConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for `GTwoDataInput`
 */
class GFieldTwoDataConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for `GDivider`
 */
class GFieldDividerConfiguration extends GFieldConfiguration {
}
/**
 * Field configuration for `GButton`
 */
class GFieldButtonConfiguration extends GFieldConfiguration {
}
...
let GsCheckboxComponent = class GsCheckboxComponent extends GsGenericFieldComponent {
    ngOnChanges(changes) {
...
let GsDropdownComponent = class GsDropdownComponent extends GsGenericFieldComponent {
    ngOnChanges(changes) {
...
let GsPhoneInputComponent = class GsPhoneInputComponent extends GsGenericFieldComponent {
    constructor() {
        super(...arguments);
    ...
    formatPhone(keyup, touched = true) {
...
let GsRadioButtonComponent = class GsRadioButtonComponent extends GsGenericFieldComponent {
    ngOnChanges(changes) {
        if (changes.fieldOption && changes.fieldOption.currentValue) {
            this.fieldOption = changes.fieldOption.currentValue;
        }
...
let GsTextInputComponent = class GsTextInputComponent extends GsGenericFieldComponent {
};
__decorate([
    Input()
...
let GsTextareaComponent = class GsTextareaComponent extends GsGenericFieldComponent {
};
__decorate([
    Input()
...
let GsMultiselectComponent = class GsMultiselectComponent extends GsGenericFieldComponent {
    constructor() {
        super(...arguments);
        this.options = [];
    ...
    toggleOption(option, touched = true) {
    ...
    toggleMultiselectOptions(value = !this.showMultiselectOptions) {
...
let GsColorPickerComponent = class GsColorPickerComponent extends GsGenericFieldComponent {
    setColorValue() {
...
let GsDividerComponent = class GsDividerComponent {
};
__decorate([
    Input()
...
let GsButtonComponent = class GsButtonComponent {
    constructor() {
...
let GsShowDataComponent = class GsShowDataComponent {
    constructor() {
        this.fieldValue = '';
    }
    ngOnInit() {
