(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common/http'), require('@angular/forms'), require('@ngx-translate/core'), require('rxjs'), require('rxjs/operators'), require('@angular/platform-browser'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@gs/ng-forms', ['exports', '@angular/core', '@angular/common/http', '@angular/forms', '@ngx-translate/core', 'rxjs', 'rxjs/operators', '@angular/platform-browser', '@angular/common'], factory) :
    (global = global || self, factory((global.gs = global.gs || {}, global.gs['ng-forms'] = {}), global.ng.core, global.ng.common.http, global.ng.forms, global.core$1, global.rxjs, global.rxjs.operators, global.ng.platformBrowser, global.ng.common));
}(this, (function (exports, core, http, forms, core$1, rxjs, operators, platformBrowser, common) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    })(exports.GFieldSelector || (exports.GFieldSelector = {}));

    (function (GFieldValueType) {
        GFieldValueType["STRING"] = "string";
        GFieldValueType["NUMBER"] = "number";
    })(exports.GFieldValueType || (exports.GFieldValueType = {}));
    ...
    })(exports.GFieldValidatorType || (exports.GFieldValidatorType = {}));
    ...
    })(exports.GFieldCountryCode || (exports.GFieldCountryCode = {}));
    ...
    })(exports.GFieldValueButtonType || (exports.GFieldValueButtonType = {}));
    ...
    var GTextField = /** @class */ (function () {
        function GTextField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TEXT;
        }
        return GTextField;
    }());
    /**
    ...
    var GTextareaField = /** @class */ (function () {
        function GTextareaField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TEXTAREA;
        }
    ...
    var GPasswordField = /** @class */ (function () {
        function GPasswordField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.PASSWORD;
        }
    ...
    var GNumberField = /** @class */ (function () {
        function GNumberField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.NUMBER;
        }
        return GNumberField;
    }());
    /**
    ...
    var GToggleField = /** @class */ (function () {
        function GToggleField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TOGGLE;
        }
        return GToggleField;
    }());
    /**
    ...
    var GCheckboxField = /** @class */ (function () {
        function GCheckboxField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.CHECKBOX;
        }
    ...
    var GRadioField = /** @class */ (function () {
        function GRadioField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.RADIO;
        }
        return GRadioField;
    }());
    /**
    ...
    var GDropdownField = /** @class */ (function () {
        function GDropdownField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.DROPDOWN;
        }
    ...
    var GTaxDocumentTypeField = /** @class */ (function () {
        function GTaxDocumentTypeField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TAX_TYPE;
        }
    ...
    var GCurrencyField = /** @class */ (function () {
        function GCurrencyField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.CURRENCY;
        }
    ...
    var GPhoneField = /** @class */ (function () {
        function GPhoneField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.PHONE;
        }
        return GPhoneField;
    }());
    /**
    ...
    var GDatePickerField = /** @class */ (function () {
        function GDatePickerField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.DATE;
        }
    ...
    var GSeparatedByComma = /** @class */ (function () {
        function GSeparatedByComma(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.COMMA;
        }
    ...
    var GFieldFile = /** @class */ (function () {
        function GFieldFile(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.FILE;
        }
        return GFieldFile;
    }());
    /**
    ...
    var GTwoDataInput = /** @class */ (function () {
        function GTwoDataInput(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TWO_DATA;
        }
    ...
    var GMultiselectField = /** @class */ (function () {
        function GMultiselectField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.MULTISELECT;
        }
    ...
    var GColorPickerField = /** @class */ (function () {
        function GColorPickerField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.COLOR;
        }
    ...
    var GMapField = /** @class */ (function () {
        function GMapField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.MAP;
        }
        return GMapField;
    }());
    /**
    ...
    var GTimeField = /** @class */ (function () {
        function GTimeField(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.TIME;
        }
        return GTimeField;
    }());
    /**
    ...
    var GDivider = /** @class */ (function () {
        function GDivider(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.DIVIDER;
            this.notWidget = true;
        }
        return GDivider;
    }());
    ...
    var GButton = /** @class */ (function () {
        function GButton(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.BUTTON;
            this.notWidget = true;
        }
        return GButton;
    }());
    ...
    var GShowData = /** @class */ (function () {
        function GShowData(config) {
            this.config = config;
            this.selector = exports.GFieldSelector.SHOW_DATA;
            this.notWidget = true;
        }
        return GShowData;
    }());
    ...
    var GsFormsService = /** @class */ (function () {
        ...
        GsFormsService.prototype.buildErrors = function (validator, value) {
            switch (validator) {
                case exports.GFieldValidatorType.MIN:
                    return forms.Validators.min(value);
                case exports.GFieldValidatorType.MAX:
                    return forms.Validators.max(value);
                case exports.GFieldValidatorType.REQUIRED:
                    return forms.Validators.required;
                case exports.GFieldValidatorType.EMAIL:
                    return forms.Validators.email;
                case exports.GFieldValidatorType.MIN_LENGTH:
                    return forms.Validators.minLength(value);
                case exports.GFieldValidatorType.MAX_LENGTH:
                    return forms.Validators.maxLength(value);
                case exports.GFieldValidatorType.PATTERN:
        ...
        GsFormsService.prototype.setDefaultFormObject = function (field, formObject, hasValidators) {
            ...
            if (hasValidators) {
                formObject[field.config.model].push(forms.Validators.compose(validators));
            }
            return formObject;
        };
        ...
        GsFormsService.prototype.fieldError = function (field) {
            ...
            if (error[exports.GFieldValidatorType.MIN]) {
                return this.getValidationMessage('ERR_MIN', error[exports.GFieldValidatorType.MIN].min);
            }
            else if (error[exports.GFieldValidatorType.MAX]) {
                return this.getValidationMessage('ERR_MAX', error[exports.GFieldValidatorType.MAX].max);
            }
            else if (error[exports.GFieldValidatorType.REQUIRED]) {
                return this.getValidationMessage('ERR_REQUIRED');
            }
            else if (error[exports.GFieldValidatorType.EMAIL]) {
                return this.getValidationMessage('ERR_EMAIL');
            }
            else if (error[exports.GFieldValidatorType.MIN_LENGTH]) {
                return this.getValidationMessage('ERR_MIN_LENGTH', error[exports.GFieldValidatorType.MIN_LENGTH].requiredLength);
            }
            else if (error[exports.GFieldValidatorType.MAX_LENGTH]) {
                return this.getValidationMessage('ERR_MAX_LENGTH', error[exports.GFieldValidatorType.MAX_LENGTH].requiredLength);
            }
            else if (error[exports.GFieldValidatorType.PATTERN]) {
        ...
        GsFormsService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function GsFormsService_Factory() { return new GsFormsService(core.ɵɵinject(forms.FormBuilder), core.ɵɵinject(core$1.TranslateService), core.ɵɵinject(http.HttpClient)); }, token: GsFormsService, providedIn: "root" });
    ...
    var GsGenericFieldComponent = /** @class */ (function () {
        function GsGenericFieldComponent(formsService) {
            ...
            this.fieldValidatorType = exports.GFieldValidatorType;
        }
    ...
    var GsCurrencyInputComponent = /** @class */ (function (_super) {
        ...
        function GsCurrencyInputComponent() {
            ...
            _this.value = '';
            _this.fieldValidatorType = exports.GFieldValidatorType;
            return _this;
        }
    ...
    var GsTwoDataInputComponent = /** @class */ (function (_super) {
        ...
        function GsTwoDataInputComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.valueType = exports.GFieldValueType;
            _this.fieldValidatorType = exports.GFieldValidatorType;
    ...
    var GsMapFieldComponent = /** @class */ (function (_super) {
        ...
        __decorate([
            core.ViewChild('mapRef', { static: false })
        ], GsMapFieldComponent.prototype, "mapElement", void 0);
        __decorate([
            core.ViewChild('search', { static: false })
    ...
    var GsButtonComponent = /** @class */ (function () {
        function GsButtonComponent() {
            this.hdlAction = new core.EventEmitter(null);
            this.fieldValueButtonType = exports.GFieldValueButtonType;
        }
    ...
    var GsFormComponent = /** @class */ (function () {
        function GsFormComponent(formsService, sanitizer, cdRef, customStyles, apikey) {
             ...
             */
            this.form = new core.EventEmitter();
            /**
             * Get form group changes. formGroup: FormGroup `form`
             */
            this.formChanges = new core.EventEmitter();
            /**
             * Get button event selected
             */
            this.customButtonClick = new core.EventEmitter();
            /**
             * Get form group changes. formGroup: FormGroup `form`
             */
            this.fieldChanged = new core.EventEmitter();
            this.fieldSelector = exports.GFieldSelector;
            this.fieldValidatorType = exports.GFieldValidatorType;
        ...
        GsFormComponent.prototype.onFormChanges = function () {
            var _this = this;
            this.formGroup.valueChanges.pipe(operators.takeUntil(this.destroyed$))
                .subscribe(function () {
        ...
        GsFormComponent.prototype.checkCondition = function (field) {
            ...
            if (this.formGroup.controls[field.config.displayIf.model].value === field.config.displayIf.hasValue) {
                ...
                if (this.formGroup.controls[field.config.model]) {
                    this.formGroup.controls[field.config.model].setValidators(forms.Validators.compose(validators));
        ...
        GsFormComponent.prototype.formActions = function (action, id) {
            switch (action) {
                case exports.GFieldValueButtonType.SUBMIT:
                    this.submit();
                    break;
                case exports.GFieldValueButtonType.RESET:
                    if (this.formGroup) {
                        this.formGroup.reset();
                    ...
                    break;
                case exports.GFieldValueButtonType.CUSTOM:
        ...
        GsFormComponent.ctorParameters = function () { return [
            ...
            { type: undefined, decorators: [{ type: core.Inject, args: ['googleMapApiKey',] }] }
        ]; };
        __decorate([
            core.Input()
        ...
        __decorate([
            core.ViewChildren(GsFileInputComponent)
        ], GsFormComponent.prototype, "fileInputComponent", void 0);
        __decorate([
            core.ViewChildren(GsDatePickerComponent)
        ], GsFormComponent.prototype, "datePickerComponent", void 0);
        __decorate([
            core.ViewChildren(GsDropdownComponent)
        ...
        GsFormComponent = __decorate([
            ...
            __param(3, core.Inject('customStyles')),
            __param(4, core.Inject('googleMapApiKey'))
        ], GsFormComponent);
    ...
    exports.GCheckboxField = GCheckboxField;
    exports.GColorPickerField = GColorPickerField;
    exports.GCurrencyField = GCurrencyField;
    exports.GDatePickerField = GDatePickerField;
    exports.GDivider = GDivider;
    exports.GDropdownField = GDropdownField;
    exports.GFieldBooleanConfiguration = GFieldBooleanConfiguration;
    exports.GFieldButtonConfiguration = GFieldButtonConfiguration;
    exports.GFieldConfiguration = GFieldConfiguration;
    exports.GFieldCountryFormmatConfiguration = GFieldCountryFormmatConfiguration;
    exports.GFieldDividerConfiguration = GFieldDividerConfiguration;
    exports.GFieldFile = GFieldFile;
    exports.GFieldFileConfiguration = GFieldFileConfiguration;
    exports.GFieldMapConfiguration = GFieldMapConfiguration;
    exports.GFieldNumberConfiguration = GFieldNumberConfiguration;
    exports.GFieldOptionValuesConfiguration = GFieldOptionValuesConfiguration;
    exports.GFieldStringConfiguration = GFieldStringConfiguration;
    exports.GFieldTwoDataConfiguration = GFieldTwoDataConfiguration;
    exports.GMapField = GMapField;
    exports.GMultiselectField = GMultiselectField;
    exports.GNumberField = GNumberField;
    exports.GPasswordField = GPasswordField;
    exports.GPhoneField = GPhoneField;
    exports.GRadioField = GRadioField;
    exports.GSeparatedByComma = GSeparatedByComma;
    exports.GShowData = GShowData;
    exports.GTaxDocumentTypeField = GTaxDocumentTypeField;
    exports.GTextField = GTextField;
    exports.GTextareaField = GTextareaField;
    exports.GTimeField = GTimeField;
    exports.GToggleField = GToggleField;
    exports.GTwoDataInput = GTwoDataInput;
    exports.GsButtonComponent = GsButtonComponent;
    exports.GsCheckboxComponent = GsCheckboxComponent;
    exports.GsColorPickerComponent = GsColorPickerComponent;
    exports.GsCurrencyInputComponent = GsCurrencyInputComponent;
    exports.GsDatePickerComponent = GsDatePickerComponent;
    exports.GsDividerComponent = GsDividerComponent;
    exports.GsDropdownComponent = GsDropdownComponent;
    exports.GsFileInputComponent = GsFileInputComponent;
    exports.GsFormComponent = GsFormComponent;
    exports.GsFormsModule = GsFormsModule;
    exports.GsFormsService = GsFormsService;
    exports.GsGenericFieldComponent = GsGenericFieldComponent;
    exports.GsMapFieldComponent = GsMapFieldComponent;
    exports.GsMultiselectComponent = GsMultiselectComponent;
    exports.GsNumberInputComponent = GsNumberInputComponent;
    exports.GsPasswordInputComponent = GsPasswordInputComponent;
    exports.GsPhoneInputComponent = GsPhoneInputComponent;
    exports.GsRadioButtonComponent = GsRadioButtonComponent;
    exports.GsSeparatedByCommaComponent = GsSeparatedByCommaComponent;
    exports.GsShowDataComponent = GsShowDataComponent;
    exports.GsTextInputComponent = GsTextInputComponent;
    exports.GsTextareaComponent = GsTextareaComponent;
    exports.GsTimePickerComponent = GsTimePickerComponent;
    exports.GsToggleComponent = GsToggleComponent;
    exports.GsTwoDataInputComponent = GsTwoDataInputComponent;
    exports.LOCATION = LOCATION;
    exports.MESSAGES = MESSAGES;
    exports.VALIDATION_MESSAGES = VALIDATION_MESSAGES;
    exports.ɵa = DigitOnlyDirective;
    exports.ɵb = ClickOutsideDirective;
    exports.ɵc = GsTextInputComponent;
    exports.ɵd = GsTextareaComponent;
    exports.ɵe = GsPasswordInputComponent;
    exports.ɵf = GsNumberInputComponent;
    exports.ɵg = GsToggleComponent;
    exports.ɵh = GsCheckboxComponent;
    exports.ɵi = GsRadioButtonComponent;
    exports.ɵj = GsDropdownComponent;
    exports.ɵk = GsCurrencyInputComponent;
    exports.ɵl = GsPhoneInputComponent;
    exports.ɵm = GsDatePickerComponent;
    exports.ɵn = GsSeparatedByCommaComponent;
    exports.ɵo = GsFileInputComponent;
    exports.ɵp = GsDividerComponent;
    exports.ɵq = GsTwoDataInputComponent;
    exports.ɵr = GsMultiselectComponent;
    exports.ɵs = GsColorPickerComponent;
    exports.ɵt = GsMapFieldComponent;
    exports.ɵu = GsButtonComponent;
    exports.ɵv = GsShowDataComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=gs-ng-forms.umd.js.map
