export declare enum GFieldSelector {
    /**
     * Any string value:
...
export declare enum GFieldValueType {
    STRING = "string",
    NUMBER = "number"
}
export declare enum GFieldValidatorType {
    MIN = "min",
    MAX = "max",
    REQUIRED = "required",
    EMAIL = "email",
...
export declare enum GFieldCountryCode {
    AR = "ar",
    BO = "bo",
    BR = "br",
    CA = "ca",
...
export declare enum GFieldValueButtonType {
    SUBMIT = "submit",
    RESET = "reset",
    CUSTOM = "custom"
}
